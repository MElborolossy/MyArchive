...
import static utils.ConstantAttributes.borderColor;
...
public class GridBagTitledPanel extends GridBagPanel {
    ...
    public GridBagTitledPanel(String title, int gridX, int gridY,int[] colWidth, double[] colWeights, int[] rowHeight,
        ...
        this.setBorder(new TitledBorder(new RoundedCornerBorder(),title,TitledBorder.RIGHT,TitledBorder.TOP, ConstantAttributes.mainFontBold,borderColor));
